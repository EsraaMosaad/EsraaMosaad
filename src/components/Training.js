...
const TrainingCard = ({ position, company,companyLink, time,address, work }) => {
    ...
    return (
        <div className="my-64">
            ...
            <div ref={ref} className="w-[75%] mx-auto relative lg:w-[90%] md:w-full">
                ...
                <TrainingCard
                    position={'Data Analysis: Skills for the Freelance Professional'}
                    company={'National Telecommunication Institute (NTI)'}
                    companyLink={'https://www.nti.sci.eg/dey/coursescrloc.php?centerID=13'}
                    time={'Jan 2025 - Mar 2025'}
                    address={'Giza (Cairo University)'}
                    work={'I developed an interactive Excel dashboard to analyze road traffic accidents and collaborated on a Power BI project to optimize food delivery trends. Using tools like Excel, Power BI, SQL, and Python, I cleaned, analyzed, and visualized data effectively. My training enhanced my skills in data storytelling, dashboard design, and teamwork.'}
                     />
