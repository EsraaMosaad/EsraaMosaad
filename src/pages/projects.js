...
import projectsData from "@/pages/projectsData"; // Import the project data
...
const Projects = () => {
    ...
    // Extract unique project types for dynamic filtering
        ...
        <>
            ...
            <main className="flex w-full mb-16 flex-col items-center justify-center dark:text-light">
                <Layout className="pt-16">
                    ...
                    <div className="flex items-center justify-center mt-4 mb-16"> {/* Full height flexbox container */}
